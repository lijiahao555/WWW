...
<div class="main-div">
<form method="post" action="<?php echo site_url('Admin/Brand/up_one') ?>" name="theForm" enctype="multipart/form-data" onsubmit="">
<table cellspacing="1" cellpadding="3" width="100%">
  <tbody>
  <tr>
    <td class="label">品牌名称</td>
    <td><input type="text" name="brand_name" maxlength="60" value="<?php echo $res['brand_name'] ?>"><span class="require-field">*</span></td>
  </tr>
  <tr>
    <td class="label">品牌网址</td>
    <td><input type="text" name="brand_url" maxlength="60" size="40" value="<?php echo $res['brand_url'] ?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><textarea name="brand_desc" cols="60" rows="4"><?php echo $res['brand_desc'] ?></textarea></td>
  </tr>
  <tr>
    <td class="label">排序</td>
    <td><input type="text" name="sort_order" maxlength="40" size="15" value="<?php echo $res['sort_order'] ?>"></td>
  </tr>
  <tr>
    <td class="label">是否显示</td>
    <td>
      <?php if ($res['is_show']==1): ?>
