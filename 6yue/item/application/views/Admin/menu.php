			...
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  ...
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Category/category') ?>" target="main-frame">商品分类</a></li>
						  ...
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Goods_type/goods_type') ?>" target="main-frame">商品类型</a></li>
