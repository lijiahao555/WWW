...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
		...
		<span class="tab-back" id="detail-editor">详细描述</span>
		<span class="tab-back" id="mix-tab">其他信息</span>
		<span class="tab-back" id="properties-tab">商品参数</span>
		<span class="tab-back" id="properties-standard">商品规格</span>
...
<!--            <td><input type="text" name="goods_number" value="4" size="20" readonly="readonly" /><br />-->
	...
	<!-- 商品参数 -->
         <table width="90%" id="properties-standard" style="display: none;" align="center">
			<tbody>
				<tr>
					<td class="label">商品类型：</td>
					<td>
