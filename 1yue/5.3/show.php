...
$sql="select id,a_type,shelf,date,number,name,price,rprice,cont,intro from shangping inner join a on shangping.type=a.a_type";
$res=mysql_query($sql);
...
<form action="seek.php" method="post">
	<input type="text" style="width:300px;height:30px" name="name" placeholder="根据手机型号搜索">
	<input type="submit" value="搜索" style="width:100px;height:30px;color:black;background:red;font-size:20px">
