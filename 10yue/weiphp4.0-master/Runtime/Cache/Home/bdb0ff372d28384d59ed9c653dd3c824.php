...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="wrap">
       ...
       <?php if(!empty($userInfo[website_logo])): ?><img height="52" src="<?php echo (get_cover_url($userInfo["website_logo"])); ?>"/>
       	<?php else: ?>
       		<img height="52" src="/10yue/weiphp4.0-master/Public/Home/images/logo.png"/><?php endif; ?>
       </a>
                ...
                <?php if(is_login()): ?><ul class="nav" style="margin-right:0">
                        ...
                        <li class="dropdown admin_nav">
                            <a href="#" class="dropdown-toggle login-nav" data-toggle="dropdown" style="">
                                ...
                                <?php else: ?>
                                    <img class="admin_head default" src="/10yue/weiphp4.0-master/Public/Home/images/default.png"/><?php endif; ?>
  ...
  <div class="wrap" style="clear:both; margin:30px auto;">
    <section class="tab-content" id="contents"> 
      ...
      <div style="overflow:hidden; zoom:1;">
        <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:30px" src="/10yue/weiphp4.0-master/Public/Home/images/weixin.png"/> 我的公众号</h3>
      ...
      <div class="data-table" style="margin:0;">
        <?php if(!empty($list_data[0])): ?><div class="table-striped">
          ...
          <?php else: ?>
          <div style="padding:100px; text-align:center;"><img style="vertical-align:middle;" src="/10yue/weiphp4.0-master/Public/Home/images/weixin.png"/> 你还没有创建公众号</div><?php endif; ?>
      </div>
    </section>
  </div>
  <div class="wrap" style="clear:both; margin:30px auto;">
    <section class="tab-content" id="contents">
      <div style="overflow:hidden; zoom:1;">
        <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:25px" src="/10yue/weiphp4.0-master/Public/Home/images/user_icon.png"/> 我的小程序</h3>
