...
<div class="tab-wrap">
    ...
    <!-- 表单 -->
    <form id='form' action='http://localhost/10yue/weiphp4.0-master/index.php?s=/w0/Admin/Menu/add.html' method='post' class='form-horizontal form-center'><input type="hidden" name="menu_type" value="1" />
<input type="hidden" name="pid" value="<?php echo ($pid); ?>" /><label class="item-label">上级菜单：<?php echo ($p_title); ?></label>
...
<block name='script'>
  <link href='/10yue/weiphp4.0-master/Public/static/datetimepicker/css/datetimepicker.css?v=1515571492' rel='stylesheet' type='text/css'>
  <link href='/10yue/weiphp4.0-master/Public/static/datetimepicker/css/dropdown.css?v=1515571492' rel='stylesheet' type='text/css'>
  ...
  <script type='text/javascript' src='/10yue/weiphp4.0-master/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1515571492' charset='UTF-8'></script> 
