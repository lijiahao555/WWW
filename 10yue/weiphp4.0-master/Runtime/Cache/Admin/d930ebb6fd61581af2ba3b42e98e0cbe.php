...
<div class="tab-wrap">
    ...
    <!-- 表单 -->
    <form id='form' action='http://localhost/10yue/weiphp4.0-master/index.php?s=/w0/Admin/Menu/add.html' method='post' class='form-horizontal form-center'><div class='form-item cf toggle-menu_type '>
...
<div class='form-item cf toggle-pid '>
			...
			<div class='controls'><div id='cascade_pid'></div><?php echo hook ( 'cascade', ['name' => 'pid', 'value' => '', 'extra' => 'type=db&table=menu&menu_type=0&uid=[manager_id]&place=1'] );?></div></div>
...
<block name='script'>
  <link href='/10yue/weiphp4.0-master/Public/static/datetimepicker/css/datetimepicker.css?v=1515571199' rel='stylesheet' type='text/css'>
  <link href='/10yue/weiphp4.0-master/Public/static/datetimepicker/css/dropdown.css?v=1515571199' rel='stylesheet' type='text/css'>
  ...
  <script type='text/javascript' src='/10yue/weiphp4.0-master/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1515571199' charset='UTF-8'></script> 
