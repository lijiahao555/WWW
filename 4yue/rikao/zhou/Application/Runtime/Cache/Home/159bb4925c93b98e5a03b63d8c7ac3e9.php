...
<center>
	<thead>
		<b>说说网</b> <span>&nbsp;<button onclick="<?php echo U('Inforshow/sou');?>">搜索</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Home/Infor/show');?>">首页</a>&nbsp;<a href="<?php echo U('Home/Inforshow/add');?>">发表说说</a>&nbsp;<?php echo $_SESSION['name'];?><a href="<?php echo U('Home/Infor/show');?>">(退出)</a></span>
		<hr width="500">
	</thead>
		关键字<input type="text">&nbsp;<input type="button" onclick="sou()" value="搜索">
	<tbody> 
...
<script>
	...
	// function save(h){
	// 	var xhr=new XMLHttpRequest();
	// 	xhr.open('get', "<?php echo U('Home/Infor/ajax');?>?h="+h)
	// 	xhr.send()
	// 	xhr.onreadystatechange=function (){
	// 		if (xhr.readyState==4&&xhr.status==200) {
	// 			document.getElementById('tbody').innerHTML=xhr.responseText
