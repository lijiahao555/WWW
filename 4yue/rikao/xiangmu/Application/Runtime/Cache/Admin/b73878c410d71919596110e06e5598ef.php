												...
												<tbody>
													<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														<td class="center">
															...
															<td><?php echo ($v["blog_content"]); ?></td>
															<td><?php echo ($v["blog_addtime"]); ?></td>
															<td><a href="javascript:del(<?php echo ($v["blog_id"]); ?>)">删除</a></td>
...
<script>
	function del(id){
		...
		xhr.open('get',"<?php echo U('Blog/del');?>?id="+id);
		xhr.send(null);
