				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" method="post" action="<?php echo U('User/userOne');?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户姓名 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="user_name" placeholder="用户姓名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-1" name="user_pwd" placeholder="用户密码" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户邮件 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="user_email" placeholder="用户邮件" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="user_tel" placeholder="用户电话" class="col-xs-10 col-sm-5" />
										</div>
									</div>
