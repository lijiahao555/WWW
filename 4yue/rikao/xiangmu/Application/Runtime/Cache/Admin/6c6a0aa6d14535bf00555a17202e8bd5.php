				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" action="<?php echo U('Label/upOne');?>" method="post"> 
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 标签名 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="label_name" value="<?php echo ($res["label_name"]); ?>" placeholder="新标签名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											<button class="btn" type="reset">
												...
												重置
											</button><input type="hidden" name="id" value="<?php echo ($id); ?>">
										</div>
									</div>
