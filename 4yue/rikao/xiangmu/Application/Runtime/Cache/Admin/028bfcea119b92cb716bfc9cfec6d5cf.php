				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" method="post" action="<?php echo U('Blog/blogOne');?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 博文标题 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="blog_title" placeholder="标题" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 博文内容 </label>

										<div class="col-sm-9">
											<textarea name="blog_content" cols="30" rows="5"></textarea>
										</div>
									</div>
