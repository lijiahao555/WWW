...
<li>
	...
	<ul class="submenu">
		...
		<li>
			<a href="<?php echo U('Category/show');?>">
				<i class="icon-double-angle-right"></i>
				分类列表
			</a>
		</li>
				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" action="<?php echo U('Category/addOne');?>" method="post"> 
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="label_name" placeholder="分类名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
