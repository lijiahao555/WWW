				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" action="<?php echo U('Type/addOne');?>" method="post"> 
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="type_name" placeholder="分类名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
