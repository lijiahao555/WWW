...
<center>
	<thead>
		...
		<b>说说网</b> <span>&nbsp;&nbsp;&nbsp;关键字<input type="text" id="sou">&nbsp;<input type="button" onclick="sou()" value="搜索">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Home/Inforshow/show');?>">首页</a>&nbsp;<a href="<?php echo U('Home/Inforshow/add');?>">发表说说</a>&nbsp;<?php echo $_SESSION['name'];?><a href="<?php echo U('Home/Infor/show');?>">(退出)</a></span>
		<hr width="500">
	</thead>
