...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="<?php echo site_url('Home/Login/login') ?>">登录</a>&nbsp; <a href="<?php echo site_url('Home/Regist/regist') ?>" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                <?php foreach ($value['son'] as $val): ?>
                                    <div class="zj_l_c">
                                        <h2><a href="<?php echo site_url('Home/Categorylist/categorylist').'/'.$val['category_id'] ?>"><?php echo $val['category_name'] ?></h2>
                            ...
                            <?php foreach ($is_hot as $key => $v): ?>
                                <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                    <div class="box">
                                        ...
                                        <div class="imgbg">
                                            <a href="<?php echo site_url('Home/Product/product').'/'.$v['goods_id'] ?>"><img width="160" height="136" src="<?php echo base_url('uploads/goods/').$v['goods_img'] ?>"></a>
                                        </div>                                        
                                        <div class="name">
