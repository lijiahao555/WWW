	...
	<div class="menu">
    	...
    	<div class="nav">
            ...
            <div class="leftNav none">
                <ul>
                    <?php foreach ($data['category_type'] as $value): ?>
                    <li>
                        <div class="fj">
...
<div class="i_bg">
    ...
    <div class="content mar_10">
    	<table border="0" class="choice" style="width:100%; font-family:'宋体'; margin:0 auto;" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="70">&nbsp; 品牌：</td>
            <td class="td_a"><?php foreach ($data['brand'] as $key => $v): ?><a href="#" class="now"><?php echo $v['brand_name'] ?></a><?php endforeach ?></td>
          </tr>
          <tr valign="top">
            <td>&nbsp; 价格：</td>                                                                                                       
            <td class="td_a"><a href="#">0-199</a><a href="#" class="now">200-399</a><a href="#">400-599</a><a href="#">600-899</a><a href="#">900-1299</a><a href="#">1300-1399</a><a href="#">1400以上</a></td>
              ...
              <tr>
                <td>&nbsp; 类型：</td>
                <td class="td_a"><?php foreach ($data['goods_type'] as $key => $v): ?><a href="#"><?php echo $v['type_name'] ?></a><?php endforeach ?></td>
              </tr>
          <tr>
            <td>&nbsp; 香型：</td>                                       
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                	<?php foreach ($data['goods'] as $v): ?>
                        <li>
                            <div class="img"><a href="<?php echo site_url('Home/Product/product').'/'.$v['goods_id'] ?>"><img src="<?php echo base_url('uploads/goods/').$v['goods_img'] ?>" width="210" height="185" /></a></div>
                            <div class="price">
                                <font>￥<span><?php echo $v['shop_price'] ?></span></font> &nbsp; 26R
                            </div>
                            <div class="name"><a href="<?php echo site_url('Home/Product/product').'/'.$v['goods_id'] ?>"><?php echo $v['goods_name'] ?></a></div>
                            <div class="carbg">
