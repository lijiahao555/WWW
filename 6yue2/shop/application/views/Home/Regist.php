            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">已有商城账号，<a href="<?php echo site_url('Home/Login/login') ?>" style="color:#ff4e00;">我要登录</a></span>
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td>
                    ...
                    <?php echo $captcha ?><font color="#ff4e00">点击图片换一张</font></a>
                </td>
              </tr>
              <tr>
              	<td>&nbsp;</td>
...
<script>
    $(document).on('click', '#Imageid', function() {
        var image = $(this);
        $.ajax({
            url: "<?php echo site_url('Home/Regist/refresh') ?>",
            type: 'get',
            dataType: 'json',
