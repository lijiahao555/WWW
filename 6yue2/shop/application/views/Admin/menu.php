		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Goods/goods_list') ?>" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Goods/goods_add') ?>" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Category/category_list') ?>" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="comment_manage.php?act=list" target="main-frame">用户评论</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Brand/brand') ?>" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Goods_type/goods_type_list')?>" target="main-frame">商品类型</a></li>
