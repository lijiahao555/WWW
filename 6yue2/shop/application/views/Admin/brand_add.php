...
<div class="main-div">
<form method="post" action="<?php echo site_url('Admin/Brand/addDo') ?>" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td><input type="text" name="sort" maxlength="40" size="15"></td>
  </tr>
  <tr>
