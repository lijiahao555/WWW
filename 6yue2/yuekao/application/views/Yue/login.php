...
<form action="<?php echo site_url('Yue/loginDo') ?>" method="post">
...
<input type="text" name="name" value="" size="35" style="height:30px"/>
</div>
<div style="width:495px;height:80px; float:right;" align="center";>
<span class="STYLE1">密  码</span>：<input type="password" name="password" value=""size="35" /style="height:30px"/>
</div>
<div style="width:495px;height:80px; float:right;" align="center";><input type="submit" value="登录" width="100" height="50" /><!-- <a href="#"><strong> 忘记密码</strong></a> --></div>
</form>
