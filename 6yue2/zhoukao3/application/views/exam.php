...
<div class="r2 w1225">
        ...
        <div class="srh">
            <form id="searchForm" name="searchForm" method="get" action="<?php echo site_url('Demo/show')?>" onsubmit="return checkSearchForm()"><input type="hidden" value="1" name="dow" id="dow">
                <input name="sou" id="w" type="text" class="tIptTxt c999 f14" value="搜索 品牌/系列/型号" title="搜索 品牌/系列/型号" onfocus="javascript:var t=$(this); if(t.val()==t.attr('title')) t.val('');" onblur="javascript:var t=$(this); if(t.val()=='') t.val(t.attr('title'));" />
...
<!--    <span class="tit" id="pop_gMenu">
    ...
    <ul id="dropdown_nav">
            ...
            <div class="sub_nav">
                      <dl>
                        <dt style="position:absolute;"><?php echo $v['type_name'] ?></dt>
                        <dd>
                ...
                <ul>
                    <?php foreach ($res as $key => $v): ?>
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-1','百达翡丽5146R-001@热销-男士-1']);">
                            ...
                            <div class="tNm"><?php echo $v['goods_name'] ?></div >
                            <div class="tPrc">￥<?php echo $v['goods_price'] ?>&nbsp;<i class="del">371100</i></div>
